    ...
    <div className="relative h-full w-full my-14 bg-white">
      ...
      <div className="relative parallax-bg h-[724px]">
        <div className="flex flex-col items-center gap-6 justify-center min-h-screen">
          <div className="flex flex-col items-center justify-center gap-2 w-[95%]">
            ...
            <p className="relative self-stretch [font-family:'Open_Sans',Helvetica] font-normal text-white text-center tracking-[0] leading-5">
