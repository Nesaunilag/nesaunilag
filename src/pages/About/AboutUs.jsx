    ...
    <div className="flex flex-col items-center px-2 md:px-0">
      <div className="container-sm md:px-5">
        ...
        <div>
          ...
          <Text
            as="p"
            className="mt-2.5 text-[20px] font-normal leading-[27px] text-[#000000]"
          >
            <>
          ...
          <Text
            as="p"
            className="mt-7 text-[20px] font-normal leading-8 text-[#4a4a4a]"
          >
          ...
          <div className="">
            ...
            <Text
              as="p"
              className="mt-1.5 text-[20px] font-normal leading-[27px] text-[#000000]"
            >
              <>
                The Nigerian Economics Students Association (NESA) University of
                Lagos Chapter has a rich history spanning over a decade. As an
              ...
              {accordionData
                ...
                .map((data, index) => (
                  <Link
                    to="/executives"
                    key={index}
                    className="flex items-center justify-between gap-5 bg-[#fffdfb] px-[60px] py-[38px] shadow-[4px_4px_20px_#0000001a]"
                  >
                    <Heading
                      as="h4"
