...
const Event = () => {
    const data = [
      {
        Image: "/images/Events/sport.jpeg",
        Title: "NESA SPORT FESTIVAL",
        Description:
          "",
        topic: "",
      ...
      },
      {
        ...
        topic: "",
        link: "https://instagram.com/nesaed",
      },
    ];
    const features = [
      {
  ...
  return (
    <main>
      <div className="flex justify-center bg-[#d97213] py-12 md:py-10">
        <div className="container-sm flex">
          <Heading
            size="heading3xl"
            as="h1"
            className="font-bold text-[#ffff] md:text-[44px] sm:text-[38px] px-5"
          >
            EXPLORE OUR EVENTS
          </Heading>
        </div>
      </div>
      <section className="container-sm flex flex-col items-start gap-[30px] px-5">
      <Text as="h2" className="text-[20px] font-semibold md:text-[44px] sm:text-[38px] mt-5">
          Upcoming Events
        </Text>
        <section>
          {data.map((d, index) => (
            ...
            >
              ...
              <div className="w-full">
                <Text className="mb-4 text-[14px] font-bold lg:text-[32px]" size="text3xl">
                  {d.Title}
                </Text>
      ...
      <div className="container-sm w-full flex flex-col items-start gap-[30px] px-5">
        <Text as="h2" className="text-[20px] lg:text-[48px] font-semibold md:text-[44px] sm:text-[38px]">
          Featured Events
        </Text>
